...
export default function WelcomeGlassHeader({ navItems = [] }) {
    ...
    return (
        <header className="rx-pro-chrome rx-mobile-topbar pointer-events-none fixed inset-x-0 top-0 z-[10001] px-0 pt-[env(safe-area-inset-top,0px)]">
            <div className="rx-mobile-topbar__shell pointer-events-auto relative mx-auto w-full max-w-none overflow-hidden rounded-none border-b border-[#38BDF8] bg-[#0F172A] px-2.5 py-2 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.65)] sm:px-3.5 sm:py-3">
                <div className="pointer-events-none absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-sky-400 to-transparent" aria-hidden />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#2563EB]/20 via-[#0F172A] to-[#F59E0B]/15" aria-hidden />
