...
const memberNav = [
    ...
    { routeKey: 'race-token', label: 'RACE TOKEN', iconKey: 'race-token' },
    { routeKey: 'investment', label: 'Staking', iconKey: 'investment' },
    { routeKey: 'lending', label: 'Lending', iconKey: 'investment' },
    { routeKey: 'transactions', label: 'Community Referrals', iconKey: 'community_referrals', query: { income: 'community_referrals' } },
    { routeKey: 'leadership', label: 'Community Leadership', iconKey: 'leadership' },
    { routeKey: 'governance', label: 'Governance', iconKey: 'leadership' },
    { routeKey: 'rewards', label: 'Team Rewards', iconKey: 'rewards' },
...
const ROUTE_TITLES = {
    ...
    team: 'Total Team',
    leadership: 'Affiliate ROI Leadership',
    rewards: 'Affiliate Team Rewards',
    transactions: 'Total Earnings',
    withdrawal: 'Payouts',
    deposit: 'Deposit',
    wallet: 'Wallet',
    'race-token': 'RACE Token',
    ico: 'ICO',
    investment: 'Packages',
    'self-hold': 'Self Hold',
    'network-roi': 'Affiliate Network of ROI',
