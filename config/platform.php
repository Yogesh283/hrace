...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Admin VIP stylesheet (full URL override for production servers)
    |--------------------------------------------------------------------------
    |
    | Leave empty to use asset('css/admin-vip.css'). Set ADMIN_VIP_CSS_URL in .env
    | if tables/dashboard styles do not load (wrong APP_URL or subdirectory).
    |
    */
    'admin_vip_css_url' => env('ADMIN_VIP_CSS_URL'),

    /*
    |--------------------------------------------------------------------------
    | Orchid published assets (live server)
    |--------------------------------------------------------------------------
    |
    | Use assets/orchid on production (many hosts block /vendor). Run:
    | php artisan rynex:publish-orchid-assets
    |
    */
    'orchid_asset_dir' => env('ORCHID_ASSET_DIR', 'assets/orchid'),
